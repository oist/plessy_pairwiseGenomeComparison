...
include { LAST_MAFCONVERT as LAST_MAFCONVERT_4_ONE2ONE_AXT } from './modules/nf-core/software/last/mafconvert/main.nf' addParams( options: ['args':"", 'suffix':'.one2one_plot'])
